...
const replace = {
    old_validator_address: "0C7C8F80C944BF5904A746B1D5AA8D6A15E6EEED",
    old_operator_address: "bitsongvaloper1dmmupr5qqy07sksct3au8tx9vuh224vg53fl6x",
    old_consensus_address: "",
    old_consensus_public_key: "IGtxbjNw7N34LT1bFXIwNfbBbdE8UUyl6pknfzag2vE=",
...
// Governance
gov.voting_params.voting_period = "900s"
...
fs.writeFile('genesis.test.json', JSON.stringify(genesis), err => {
    if (err) {
        console.error(err)
        return
    }
